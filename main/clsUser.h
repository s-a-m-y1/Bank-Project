...
public:
    ...
    enum enPermissions {all =-1 , pListClients = 1 , pAddNewClient = 2 , pDeleteClient = 4 , pUpdateClients = 8 , pFindClient
     = 16 , pTranactions
    =32 , pManageUsers
     = 64 };
    ...
    static StDataLoginRegister LoadDate(string line , string Spretor ="#//#")
    {
        StDataLoginRegister L;
    ...
    void AddLoginRegister()
    {
        ...
        if (MyFile.is_open())
        {
			MyFile << _ConvertLineThisUser() << endl;
                        MyFile.close();
        }
		//This will add new record to file or database

    }
   static vector <StDataLoginRegister> LoadDataFromFIle()
    {
		fstream MyFile;
        //StDataLoginRegister Data;
        vector<StDataLoginRegister>Vdata;
